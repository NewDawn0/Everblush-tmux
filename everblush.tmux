...
main() {
  ...
  local wt_enabled
  wt_enabled="$(get_tmux_option "@everblush_window_tabs_enabled" "off")"
  readonly wt_enabled
  ...
  readonly show_directory_in_window_status_current="#[fg=$thm_bg,bg=$thm_magenta] #I #[fg=$thm_fg,bg=$thm_bg] #{b:pane_current_path} "
